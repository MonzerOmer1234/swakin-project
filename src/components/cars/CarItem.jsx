import carImg from "../../imgs/mrs-lg.png";

export default function CarItem() {
  return (
    <>
      <div
        class="col-span-4 details mb-5 ms-3"
        style={{ backgroundColor: "#fff", borderRadius: "8px" , width: 'calc(33% - 15px)' }}
      >
        ...
        <div>
          <p className="p-5 me-5 flex ">
            ...
            <span className="ms-3 text-[#6B7280]">2024</span>
          </p>
        </div>
        <div>
          <p className="p-5 me-5 flex">
            ...
            <span className="ms-3 text-[#6B7280]">Color : Black</span>
          </p>
        </div>
        <div>
          <p className="p-5 me-5 flex">
        ...
        <div className="p-5 flex gap-2 whitespace-nowrap update items-center justify-between">
          <button
            className="justify-center flex bg-[#CCFBF1] p-1"
          ...
          >
            ...
            <span className=" ms-2 text-[#115E59] font-semibold">
              Edit Car Info
            </span>
          </button>
          <button
          ...
          >
            ...
            <span className=" ms-2 text-[#991B1B]  ">Delete Car</span>
          </button>
        </div>
      </div>
    </>
